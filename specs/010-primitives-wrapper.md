...
| `password` | ≥ 1 B (wrapper guard, not a libsodium bound: no key is derived from an empty password; the maximum length is fixed by spec 011-config-format) | 0 → `BadLength` |
